...
export default function StudentDashboard() {
  ...
  const getPerformanceTheme = (data: any[]) => {
    ...
    if (avg <= 75)
      return { stroke: "#eab308", fill: "#eab308", label: "Average" };
    ...
    <div className="space-y-8 p-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-2xl border border-zinc-100 shadow-sm">
          ...
          <span className="text-sm font-bold text-zinc-900 uppercase tracking-widest font-mono">
            Student Hub
          </span>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-[32px] border border-zinc-200 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-zinc-50">
            {pastTests.map((test, i) => (
              <div
                key={i}
                className="p-5 hover:bg-zinc-50/50 transition-colors flex items-center justify-between group cursor-pointer"
              >
              ...
              {recommended.map((rec, i) => (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-[8px] px-2 py-0.5 rounded-full bg-white/10 border border-white/10 uppercase font-black">
                      {rec.difficulty}
                    </span>
                  </div>
                  <p className="font-bold text-base mb-2">
                    {rec.company} Practice
                  </p>
